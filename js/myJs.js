    ...
    Swal.fire({
        ...
        if (result.value) {
            Swal.fire({
                ...
                text: "Mình hẹn hò nhaaaa :v Còn giờ thì chờ gì nữa mà ko inbox cho tớ đi nàoooooo",
                confirmButtonColor: '#83d0c9',
                onClose: () => {
                    window.location = 'https://www.facebook.com/nhos.nghias';
                  }
            })
        }
    })
